  ...
  return (
    <>
      ...
      <div className="text-center my-3">
        ...
        <Button className="border-white" variant="secondary" size="lg">
          GLOBAL
        </Button>
        <Button className="border-white" variant="secondary" size="lg">
          REGIONAL
      ...
      <div className="">
        <div className="flex  w-full justify-between items-center mb-2 border-2 border-black rounded-md">
